...
public class PhasedDiagnosticTestGenerated extends AbstractPhasedDiagnosticTest {
  ...
  public class Verification {
    ...
    public class Classes {
      ...
      @Test
      @TestMetadata("custom_predicates_ki01_overload_collision.kt")
      public void testCustom_predicates_ki01_overload_collision() {
        runTest("formver.compiler-plugin/testData/diagnostics/verification/classes/custom_predicates_ki01_overload_collision.kt");
      }

      @Test
      @TestMetadata("custom_predicates_ki02_value_parameter.kt")
      public void testCustom_predicates_ki02_value_parameter() {
        runTest("formver.compiler-plugin/testData/diagnostics/verification/classes/custom_predicates_ki02_value_parameter.kt");
      }

      @Test
      @TestMetadata("custom_predicates_ki03_nonlambda_argument.kt")
      public void testCustom_predicates_ki03_nonlambda_argument() {
        runTest("formver.compiler-plugin/testData/diagnostics/verification/classes/custom_predicates_ki03_nonlambda_argument.kt");
      }

      @Test
      @TestMetadata("custom_predicates_ki03_nonlambda_spec_block.kt")
      public void testCustom_predicates_ki03_nonlambda_spec_block() {
        runTest("formver.compiler-plugin/testData/diagnostics/verification/classes/custom_predicates_ki03_nonlambda_spec_block.kt");
      }

      @Test
      @TestMetadata("custom_predicates_ki04_full_permission.kt")
      public void testCustom_predicates_ki04_full_permission() {
        runTest("formver.compiler-plugin/testData/diagnostics/verification/classes/custom_predicates_ki04_full_permission.kt");
      }

      @Test
      @TestMetadata("custom_predicates_ki05_generic_class.kt")
      public void testCustom_predicates_ki05_generic_class() {
        runTest("formver.compiler-plugin/testData/diagnostics/verification/classes/custom_predicates_ki05_generic_class.kt");
      }
